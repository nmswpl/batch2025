...
public class MoviesArray {
    public static void main(String[] args) {
        ...
        Movie sivajiTheBoss = new Movie("Sivaji:The Boss", 2007, "Action");
        Movie petta = new Movie("Petta", 2019, "Action");
        Movie thalapathi = new Movie("Thalapathi", 2007, "Drama");
        Movie shivaji = new Movie("Shivaji", 2007, "Action");
        Movie kaala = new Movie("Kaala", 2018, "Drama");

        Movie[] arr = new Movie[] {enthiran, kabali, superstar, baasha, muthu, sivajiTheBoss, petta, thalapathi, shivaji, kaala};
