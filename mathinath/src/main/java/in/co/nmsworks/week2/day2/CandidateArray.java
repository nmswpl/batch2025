...
public class CandidateArray {
    public CandidateArray(int id,String str1,String str2,String str3) {
    }
    ...
    public static void main(String[] args) {
        new CandidateArray().printCandidate();
    }
    ...
    public  void  printCandidate() {
       ...
       Candidate[] candidates = new Candidate[] {c21,c22,c23,c24,c25,c25,c26,c27,c28,c29,c30,c31,c32,c33,c34};
        candidates[0]=c21;
        candidates[1]=c22;
        candidates[2]=c23;
        candidates[3]=c24;
        ...
        for(int i=0;i< candidates.length;i++)
        {
            String dept=candidates[i].getdepartment();
