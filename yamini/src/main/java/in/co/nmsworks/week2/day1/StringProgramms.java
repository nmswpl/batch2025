...
public class StringProgramms {
    public static void main(String[] args) {
        ...
        subStringswithLimitIndex("apple;banana;cherry;date",3);
        printIndex("programming","g");

        lowerCaseConversion("Java Programming");
        upperCaseConversoin("welcome to java");
    ...
    public  static void printSubString(String input,int begInde,int lastIndex){
        System.out.println(input.substring(begInde,lastIndex));
    }
    ...
    public static void subStringswithLimitIndex(String input,int limit){
    ...
    public static void upperCaseConversoin(String input){
