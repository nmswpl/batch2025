...
public class ParagraphToNewLine {

    public static void printingInNewLine(String[] splittedParagraph) {

        for( int i = 0; i < splittedParagraph.length; i++) {
            System.out.println(splittedParagraph[i].trim());
        }
    }
    ...
    public static void main(String[] args) {
        ...
        printingInNewLine(splittedParagraph);
    }
}
